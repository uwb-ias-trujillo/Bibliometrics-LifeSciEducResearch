...
# Plot the network
net = networkPlot(NetMatrix, n = dim(NetMatrix)[1], Title = "Co-Citation Network", type = "fruchterman", size=T, remove.multiple=FALSE, labelsize = 3, edgesize = 5, edges.min = 4, label.n = 30, cluster = "louvain", remove.isolates = TRUE, label.cex = TRUE)
