...
# Plot the network
net=networkPlot(NetMatrix, n = 200, Title = "University Collaboration", type = "fruchterman", size=T, remove.multiple=FALSE, labelsize=0.7,edgesize = 5, edges.min = 3, label.n = 30)
