...
txt <- c("rawdata/VQD/20200315_QDV_WoS_Record1to500_QualResearch_KW.txt",
         ...
         "rawdata/VQD/20200316_QDV_WoS_Record1to500_DataVis_HN.txt",
         "rawdata/VQD/20200316_QDV_WoS_Record501to1000_DataVis_HN.txt",
         "rawdata/VQD/20200316_QDV_WoS_Record1001to1500_DataVis_HN.txt",
         "rawdata/VQD/20200316_QDV_WoS_Record1501to2000_DataVis_HN.txt",
         "rawdata/VQD/20200312VQD_Applied_1-500.txt",
         "rawdata/VQD/20200312VQD_Applied_501-1000.txt"
         )
...
# Plot the network
net <- networkPlot(NetMatrix, n = dim(NetMatrix)[1], Title = "Co-Citation Network Qualitative Research with at least 8 co-citations", type = "auto", size.cex = TRUE, remove.multiple=TRUE, labelsize = 10, edgesize = 5, edges.min = 6, label.n = 30, cluster = "louvain", #halo = TRUE, weighted = TRUE, 
