...
CoAMatrix <- biblioNetwork(data, analysis = "collaboration", network = "authors", sep = ";",short = TRUE)

# Plot the network - look into SNA application
CoANet <- networkPlot(CoAMatrix, n = dim(CoAMatrix)[1], Title = "Social Network Analysis", type = "fruchterman", size=0.1, remove.multiple=TRUE, labelsize = 2, weighted = TRUE, curved = TRUE, edgesize = 5, edges.min = 1, halo = TRUE, label.n = 10,  cluster = "louvain", remove.isolates = TRUE, community.repulsion = 1)
...
```{r top cited papers and sources}
=======
```{r citation}
library(stringdist)
library(stringr)
...
>>>>>>> db8511d25e37ecf888de6792ee7c2327b71597ab
