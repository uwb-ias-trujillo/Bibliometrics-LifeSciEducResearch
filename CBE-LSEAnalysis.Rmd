...
AffiliationWorldMap <- countries %>%
  ...
  geom_point(data = worldcentroids, aes(x = longitude, y = latitude, size = Freq, group = region)) +
    geom_text(data = worldcentroids, aes(x = longitude, y = latitude, label = Freq, size = Freq/6, group = region), color = "white") +
...
ArticlesUSMap <- ggplot() +
  ...
  geom_point(data = centroids, aes(x = longitude, y = latitude, size = articles*100)) +
