...
prodplot <- ggplot(data = AnnualProduction, 
  ...
  geom_text(data = AnnualProduction %>% filter(Year %in% c(2010,2020)), 
   ...
   geom_text(data = AnnualProduction %>% filter(Year %in% c(2010)), 
            aes(x = Year, y= edrline+1, label = "Eds: Wood  "), 
            color = "#444444", 
            hjust = 1, 
            vjust = 1) +
  geom_text(data = AnnualProduction %>% filter(Year %in% c(2010)), 
            aes(x = Year, y= edrline+1, label = " Dolan"), 
            color = "#444444", 
            hjust = "left", vjust = 1) +
  geom_text(data = AnnualProduction %>% filter(Year %in% c(2020)), 
            aes(x = Year, y= edrline +1, label = " Schinske-\n Tanner", color = "#444444"), 
...
authorprod <- ggplot(df2, aes(x = .data$Author, y = .data$year,
  ...
  theme_default+
    ...
    labs(title = "Author productivity", #subtitle = "Author name by H-index", 
         x = NULL, y = NULL) +
