...
prodplot <- ggplot(data = AnnualProduction, 
  ...
  #            aes(x = Year, y= edrline),
  #            color = "#444444", label = "▶", family = "HiraKakuPro-W3", size = 3) +
...
# 
# df <- data.frame(i = 0, C1 = "", region = "", count = "")
# i = 1
# colnames(df) <- c("i","C1","region","count")
# 
# for(region in countries$region) {
#   for (x in data$C1){
#     #str_count(x,str_to_upper(region),na.rm = TRUE)
#     info <- c(i,x,region)
#     df<- rbind(df,info)
#   }
#   i<-i+1
