...
ggplot() +
  ...
  #geom_text_repel(data= centroids, aes(x = longitude, y = latitude, label = articles)) +
  #coord_map("albers", lat0 = 39, lat1 = 45) +
  coord_equal() +
  theme_map() +
  #theme_default +
...
ggsave("figures/ArticlesUSMap.jpg", device = "jpeg", dpi = 400,  width = 7,
  height = 5,
  units = "in", limitsize = FALSE)
...
ggsave("figures/ArticlesUSMapCopy.jpg",
       device = "jpeg", dpi = 400,
       width = 7, height = 5,
       units = "in", limitsize = FALSE)
```
