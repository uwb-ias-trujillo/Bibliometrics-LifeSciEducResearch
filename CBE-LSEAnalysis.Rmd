...
>>>>>>> afb65b5c365971e1970b3e9a47d6f21532f533a7:CBE-LSEAnalysis.Rmd
...
Summary(Uni_NetStat) #Centrality shows how importance the nodes are
```
Text to explain what is shown in the figures.
...
# Plot the network
net = networkPlot(NetMatrix, n = 200, Title = "Co-Citation Network", type = "fruchterman", size=T, remove.multiple=FALSE, labelsize = 10, edgesize = 5, edges.min = 4, label.n = 30, cluster = "louvain", remove.isolates = TRUE, label.cex = TRUE)
