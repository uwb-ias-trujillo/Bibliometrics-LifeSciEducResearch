...
write_graph(net$graph,"CBE_LSE_Coauthorshipedge4.graphml", c("graphml"))


net2=networkPlot(NetMatrix, n = dim(NetMatrix)[1], Title = "Top  University Collaborations", type = "auto", size.cex =TRUE, remove.multiple=FALSE, remove.isolates = TRUE, labelsize=0.7,edgesize = 5, edges.min = 1)

plot(net2$graph, vertex.label.family = "Helvetica")
write_graph(net$graph,"CBE_LSE_Coauthorshipedge1.graphml", c("graphml"))
```
Text to explain what is shown in the figures.
