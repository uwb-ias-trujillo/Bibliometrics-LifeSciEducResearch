...
CS <- conceptualStructure(data,field ="ID", method = "MCA", minDegree=19, clust= 3 ,k.max=20, stemming=FALSE, labelsize=10, documents=10)

CS <- conceptualStructure(data,field ="ID", method = "MCA", minDegree=19, clust= 3 ,k.max=20, stemming=TRUE, labelsize=10, documents=10)
