...
DCA1 = networkPlot(DCAMatrix, n = dim(DCAMatrix)[1], Title = "Co-Citation Network", type = "auto", size.cex = TRUE, remove.multiple=FALSE, labelsize = 10, edgesize = 5, edges.min = 1, label.n = 30, cluster = "louvain", remove.isolates = TRUE, label.cex = TRUE)

plot(DCA1$graph, vertex.label.family = "Helvetica")
names(DCA1$nodeDegree["american association 2011-1"])<- "AAAS 2011"
DCA1$nodeDegree

write_graph(DCA1$graph,"CBE_LSE_DCAedge1.graphml", c("graphml"))
