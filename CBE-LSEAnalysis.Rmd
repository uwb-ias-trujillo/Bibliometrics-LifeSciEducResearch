...
CS15 <- bibliometrix::conceptualStructure(data, 
                          field ="ID", 
                          ngrams = c(1,2), 
                          method = "MCA", 
                          minDegree= 15,
...
ggsave("figures/15ConceptualStructure.png", plot = CS19$graph_terms, device = "png")

ggsave("figures/15ConceptualCluster.png", plot = CS19$graph_dendogram + coord_flip(), device = "png")
```
