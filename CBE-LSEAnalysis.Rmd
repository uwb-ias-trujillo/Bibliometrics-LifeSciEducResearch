...
ggsave("figures/ConceptualStructure.png", plot = CS2$graph_terms, device = "png")


ggsave("figures/ConceptualCluster.png", plot = CS2$graph_dendogram + coord_flip(), device = "png")
```
