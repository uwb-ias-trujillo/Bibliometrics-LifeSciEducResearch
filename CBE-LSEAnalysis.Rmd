...
BCnet = networkPlot(BC, n = dim(BC)[1], Title = "Bibliographic Coupling", type = "auto", size.cex = TRUE, remove.multiple=FALSE, labelsize = 10, edgesize = 5, edges.min = 6, label.n = 30, cluster = "louvain", remove.isolates = TRUE, label.cex = TRUE)

ggsave("bibliographiccoupling.png", plot = BCnet$graph_terms, device = "png")
```
