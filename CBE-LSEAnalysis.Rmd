...
ggsave("figures/ConceptualStructure.png", plot = CS30$graph_terms, device = "png")

ggsave("figures/ConceptualCluster.png", plot = CS30$graph_dendogram + coord_flip(), device = "png")
