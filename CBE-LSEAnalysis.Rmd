...
ggsave("AnnualProductivity.jpg", device = "jpeg", dpi = 400)
...
ggsave("SchoolTypes.jpg", device = "jpeg", dpi = 400)
...
MSIAffiliationPlot
ggsave("MsiAffiliations.jpg", device = "jpeg", dpi = 400)
...
ggsave("CoAuthorshipNetwork4.jpg", device = "jpeg", dpi = 400)
...
ggsave("CollaborationNetwork4.jpg", device = "jpeg", dpi = 400)
...
ggsave("AffliationsTop10.jpg", device = "jpeg", dpi = 400)
...
ggsave("DocumentCocitationNetwork.jpg", device = "jpeg", dpi = 400)
