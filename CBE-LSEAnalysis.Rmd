...
DCA2 = networkPxlot(DCAMatrix, n = dim(DCAMatrix)[1], Title = "Co-Citation Network", type = "auto", size.cex = TRUE, remove.multiple=FALSE, labelsize = 10, edgesize = 5, edges.min = 2, label.n = 30, cluster = "louvain", remove.isolates = TRUE, label.cex = TRUE)
